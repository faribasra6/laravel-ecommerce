                ...
                <div class="card">
                    <div class="card-body">							
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="password">Password:(To update the user's password, please enter the new password.)</label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control" >
                                        ...
                                        <option value="inactive" {{ ($userData->status == 'inactive')? 'selected': ''}}>Blocked</option>
...
<script>
   $("#UsersForm").submit(function(event) {
    ...
    $.ajax({
        url: '{{ route("users.update", $userData->id) }}',
        type: 'POST',
        data: $(this).serialize(),
